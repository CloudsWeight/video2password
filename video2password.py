...
# function to convert your_file into .wav format
def convertCLip():
    nameTxt = input("What do you want to name the text file? (Do not add the .txt):")
    # your_file  = str(your_file)
    clip = mp.VideoFileClip(your_file)
    clip.audio.write_audiofile(nameTxt+".wav")
